        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-6">
          <div>
            ...
            <div className="flex items-center gap-3">
              <a href="https://github.com/John-Akech/SouthSudanFLoodSense" target="_blank" rel="noopener noreferrer" className="w-9 h-9 bg-slate-800 rounded-lg flex items-center justify-center hover:bg-blue-600 transition-colors group">
              ...
              <a href="mailto:j.akech@alustudent.com" className="w-9 h-9 bg-slate-800 rounded-lg flex items-center justify-center hover:bg-blue-600 transition-colors group">
