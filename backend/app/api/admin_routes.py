...
async def approve_prediction(
    ...
    prediction.approved_at = datetime.utcnow()
...
async def retract_alert(
    ...
    prediction.retracted_at = datetime.utcnow()
...
async def get_admin_metrics(
    ...
    approved = db.query(DBPrediction).filter(DBPrediction.published == True).count()
    pending = db.query(DBPrediction).filter(DBPrediction.published == False).count()
