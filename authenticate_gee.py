...
def check_gee_auth():
    ...
    try:
        ...
        print(f"[FAIL] GEE not authenticated: {e}")
        return False
...
def authenticate_gee():
    ...
    try:
        ...
        if result.returncode == 0:
            ...
            print(f"[FAIL] Authentication failed: {result.stderr}")
            return False
            
    except FileNotFoundError:
        print("[FAIL] 'earthengine' command not found.")
...
def setup_service_account():
    ...
    if service_account_path.exists():
        ...
        try:
            ...
            print(f"[OK] Service account: {key_data.get('client_email', 'Unknown')}")
        except Exception as e:
            print(f"[FAIL] Invalid service account file: {e}")
    else:
        print("[INFO] No service account file found (using personal auth)")
...
def main():
    ...
    if check_gee_auth():
        print("[OK] No authentication needed")
